...
//                    attendance.setSigns(new Sign(ESign.H_P));
                ...
                if(!attendance.getTimeOut().isAfter(afternoonShift.getStartTime())){
                    LocalTime regularHour = attendance.getTimeOut().minusHours(attendance.getTimeIn().getHour()).minusMinutes(attendance.getTimeIn().getMinute()).minusSeconds(attendance.getTimeIn().getSecond());
                    attendance.setRegularHour(regularHour);
//                    attendance.setSigns(new Sign(ESign.H));
                }
//                attendance.setTotalWork(attendance.getRegularHour().plusHours(attendance.getOverTime().getHour())
